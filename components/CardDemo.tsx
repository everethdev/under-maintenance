...
export function CardDemo() {
  return (
    <Card>
      ...
      <CardTitle>EETH Dividends</CardTitle>
      <CardDescription>
  ...
  return (
    ...
    <div className="flex flex-row flex-shrink-0 justify-center items-center gap-2">
      ...
      <Container className="h-12 w-12 circle-2">
        <EthereumLogo className="h-6 w-6 dark:text-white" />
      </Container>
      <Container className="circle-3">
        <EthereumLogo className="h-8 w-8 dark:text-white" />
      </Container>
      <Container className="h-12 w-12 circle-4">
        <EthereumLogo className="h-6 w-6" />
      </Container>
